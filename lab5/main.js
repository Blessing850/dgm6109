...
function makeDrawing(canvas, choice1, x1, y1, choice2, x2, y2, showOrigin) {
    ...
    // Helper function to safely call any drawing function
    function safeDraw(funcName, targetCanvas, x, y, showOrigin) {
        if (typeof window[funcName] === "function") {
            try {
                ...
                console.warn(`${funcName} standard call failed. Trying alternative parameter orders...`, e);
                ...
                console.error(`Could not draw ${funcName}. Please check the function parameters.`);
            }
        } else {
    ...
    // Create groups for both drawings
